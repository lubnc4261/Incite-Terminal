...
def rmfile(option1:str, option2:str):
    ...
    if option1 is not None and option2 == defaultValue:
        try:
            if option1 == "normal":
                ...
                os.remove(option1)
                if os.path.isfile(option1) == False:
            ...
            print(Beauty.Fore.RED + "Missing permissions to remove a file" + Beauty.Fore.RESET)

        except FileNotFoundError:
            print(Beauty.Fore.YELLOW + "File not found" + Beauty.Fore.RESET)
...
def rmfile_man():
    print(Beauty.Style.DIM +"Command Manual: rmfile" + Beauty.Style.RESET_ALL)
    print("       ")
    print(Beauty.Style.DIM + "Usage:" + Beauty.Style.RESET_ALL)
    print("rmfile <name>.<extension> : - Deletes a file\n")
    print(Beauty.Style.DIM + "Description:" + Beauty.Style.RESET_ALL)
    print("File deletion command\n")
